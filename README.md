# Network Analysis of Auhtors on Academic Publications
...
## References
The following article was useful in developing the code: https://programminghistorian.org/en/lessons/exploring-and-analyzing-network-data-with-python 
